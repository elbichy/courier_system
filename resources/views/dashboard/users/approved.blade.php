		...
		<div class="content-container white">
			<div class="sectionWrap">
                ...
                <div class="sectionTableWrap" style="padding-top:0px;">
                    <h6 style="padding:12px; background:#eee; text-align:center; font-weight:bold;">Approved Users</h6>
                        ...
                        <tbody>
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>{{ $user->email }}</td>
                                    <td>
                                        <a href="{{ route('editUser', $user->id) }}" class="btn waves-effect green waves-light">Edit</a>
